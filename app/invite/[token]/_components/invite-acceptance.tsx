      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription className="text-base">
            {invitation.brokerName} from {invitation.brokerCompany} has invited
            you to join MortMonitor
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">
                  Monitor Your Refinancing Opportunities
                </p>
                <p className="text-sm text-muted-foreground">
                  Get alerts when rates drop and you can save money on your
                  mortgage
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your broker covers all monitoring fees
                </p>
              </div>
            </div>
          </div>
