...
import { TrendingDown, Bell, DollarSign, Users, FileText, Activity, HandCoins, Pencil } from "lucide-react"
      ...
      <Card className="border-l-4 border-l-slate-500 gap-0">
        <CardHeader>
          <CardTitle className="flex justify-between gap-2">
            ...
            <span className="text-sm text-gray-500">{loanData.propertyAddress}</span>
</span>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-8 gap-1 text-center">
            <div>
              ...
              <p className="text-xs text-gray-500">At the time of last appraisal</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-2xl font-bold">${loanData.remainingBalance.toLocaleString()}</p>
              <p className="text-xs text-gray-500">Based on what you still owe and your minimum monthly payment.</p>
            </div>
            <div>
