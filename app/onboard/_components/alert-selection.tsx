...
export function AlertSelection({
  ...
  const calculateLoanEndDate = (): string => {
    ...
    const endDate = new Date(
      startDate.getFullYear() + termYears,
      startDate.getMonth(),
      1,
    );
  ...
  const alerts: (AlertTemplate & { isRecommended?: boolean })[] = [
    ...
    },
    {
      ...
      description:
        "Alert me when I could break even within M months by refinancing today.",
      icon: Clock,
    ...
    <Card ref={cardRef} className="w-full max-w-3xl mx-auto">
      <CardHeader className="text-center">
        <CardTitle className="text-xl sm:text-2xl">
          Choose your alerts and start saving
        </CardTitle>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  >
                    {isSelected && (
                      <Check className="h-5 w-5 sm:h-4 sm:w-4 text-primary-foreground" />
                    )}
                  </div>
        ...
        {showInviteOption && onSendInviteChange && (
          <div className="mt-6 p-4 border rounded-lg bg-muted/30">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  onSendInviteChange(checked === true)
                }
              />
              <Label
                htmlFor="sendInvite"
            ...
            <p className="text-xs text-muted-foreground mt-2 ml-6">
              Client will receive an email to set up their password and access
              their account
            </p>
          </div>
        )}
