...
export function ClientInfoStep({
  ...
  const isFormValid = firstName.trim() && lastName.trim() && email.trim() && creditScore
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={creditScore} onValueChange={onCreditScoreChange}>
                <SelectTrigger id="creditScore" className="h-10" aria-invalid={!!errors.creditScore}>
              ...
              {errors.creditScore && (
                <p id="creditScore-error" className="text-sm text-destructive" role="alert">
                  {errors.creditScore}
                </p>
              )}
            </div>
