  ...
  const handlePropertyComplete = async () => {
    ...
    try {
      ...
      const property = await createProperty({
        ...
        address: fullAddress,
        propertyPrice: Number.parseFloat(
          state.propertyPrice.replace(/[^0-9.]/g, ""),
        ),
        originalLoanAmount: Number.parseFloat(
          state.originalLoanAmount.replace(/[^0-9.]/g, "") || "0",
        ),
        currentBalance: Number.parseFloat(
          state.currentBalance.replace(/[^0-9.]/g, ""),
        ),
        ...
        monthlyPayment: Number.parseFloat(
          state.monthlyPayment.replace(/[^0-9.]/g, ""),
        ),
      });
  ...
  const handleFinalSubmit = async () => {
    if (!state.clientId || !state.propertyId) {
      toast({
        ...
        title: "Error",
        description:
          "Missing client or property information. Please start over.",
      });
      return;
    }
    ...
    try {
      ...
      if (state.sendInvite) {
        // TODO: Call API to send invitation email
        toast({
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12">
        {state.currentStep === 1 && (
          <ClientInfoStep
            ...
            onCreditScoreChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "creditScore", value })
            }
        ...
        {state.currentStep === 2 && (
          <PropertyDetails
            ...
            onPropertyAddressChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "propertyAddress", value })
            }
            onPropertyCityChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "propertyCity", value })
            }
            onPropertyStateChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "propertyState", value })
            }
            onPropertyZipChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "propertyZip", value })
            }
            onPropertyPriceChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "propertyPrice", value })
            }
            ...
            onCurrentBalanceChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "currentBalance", value })
            }
            onInterestRateChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "interestRate", value })
            }
            onTermLengthChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "termLength", value })
            }
            onStartMonthChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "startMonth", value })
            }
            onStartYearChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "startYear", value })
            }
            onMonthlyPaymentChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "monthlyPayment", value })
            }
            onCreditScoreChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "creditScore", value })
            }
        ...
        {state.currentStep === 3 && (
          <AlertSelection
            ...
            onSendInviteChange={(value) =>
              dispatch({ type: "SET_FIELD", field: "sendInvite", value })
            }
